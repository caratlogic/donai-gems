...
import { createGemSchema, CreateGem } from "@/lib/validations/gems-Schema";
import {
    Dialog,
    DialogContent,
    DialogDescription,
    ...
    const onSubmit = async (data: CreateGem) => {
        try {
            ...
            const response = await axios.post(
                "https://api-gems-inventory.onrender.com/api/gems/create",
                data
            );
            ...
            if (response.data.success) {
                ...
                toast.error(response.data.message || "Failed to create gem");
            }
        } catch (error) {
        ...
        <Dialog open={isOpen} onOpenChange={handleClose}>
            <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Fill in the details to add a new gem to the inventory.
                    </DialogDescription>
                </DialogHeader>
