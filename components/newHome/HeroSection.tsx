...
import HeroBanner from "@/public/newHome/WelcomeSection/bannerTest.jpg";
            ...
            <div className="absolute -top-10 left-30  ">
                ...
                >
                    <motion.h1
                        ...
                        className={`text-4xl md:text-5xl lg:text-6xl max-w-xl font-normal leading-tight mb-6 text-black ${playfair.className}`}
                    >
                    ...
                    >
                        <Link href="/gemstones">
                            <button className="group relative overflow-hidden bg-[#AB8965]   px-5 py-2 text-white hover:shadow-[-10px_-10px_30px_4px_rgba(0,0,0,0.1),_10px_10px_30px_4px_rgba(45,78,255,0.15)] transition-all duration-300 ease-in-out">
