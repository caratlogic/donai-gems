...
import gemApart from "../assets/gemApart.jpg";
  ...
  return (
    <div className='max-w-7xl mx-auto w-full flex flex-col md:flex-row justify-between gap-10 bg-[#FAF8F2] mt-20 lg:mt-30'>
      ...
      <div className='flex flex-col py-15 mt-15 max-w-xl mx-auto items-center lg:items-start'>
        ...
        <div className={`mt-10 ${openSans.className} font-light text-md text-[#2E2B28CC] text-center lg:text-left lg:text-xl`}>
          <p>A century-old legacy of curating the rarest gemstones with uncompromising integrity.</p>
        </div>

        <button className={`mt-10 ${openSans.className} h-10 text-[#2E2B28] border border-[#2E2B28] px-3 hover:bg-[#2E2B28] hover:text-[#FFFFFF] transition-all duration-300`}>BOOK A MEETING</button>
      </div>
    </div>
  )
}
