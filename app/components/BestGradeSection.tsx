      ...
      <div className="max-w-7xl mx-auto mt-10 ">
        <div className="flex lg:flex-row flex-col gap-1 items-center justify-center">
          ...
          >
            ...
            >
              Welcome to DONAI, Antwerp&apos;s premier source for high-grade
              natural gemstones — trusted by global jewellers, designers, and
              collectors. Our core lies in precision-selected gems, while a
              select few are transformed into exclusive jewellery creations.
            </p>
