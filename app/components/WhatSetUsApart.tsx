...
const WhatSetsUsApart = () => {
  return (
    <section className="max-w-7xl mx-auto relative w-full bg-[#FAF8F2] mt-20 py-20 px-4 md:px-24 text-[#2E2B28] font-sans overflow-hidden">
      {/* Decorative Stars */}
          ...
          {features.slice(0, 2).map((feature, index) => (
            ...
            >
              ...
              <p className="text-sm text-[#FFFFFF] opacity-85 mt-3">
                {feature.description1} <br /> {feature.description2}
              </p>
            </div>
          ))}
        </div>
