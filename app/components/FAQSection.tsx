...
const faqs: FAQ[] = [
  ...
  },
  {
    ...
    answer:
      "All gemstones we use are ethically sourced, certified, and 100% natural.",
  },
  {
    id: 4,
    question: "How long does a custom order take to deliver?",
    answer:
      "Custom orders typically take 3–6 weeks depending on design complexity.",
  },
  {
    id: 5,
    question: "Can I request a private collection preview?",
    answer:
      "Yes, we can arrange private appointments for viewing exclusive collections.",
  },
  {
    id: 6,
    question: "Can I order a custom-designed piece?",
          ...
          return (
            ...
            >
              <div className="flex justify-between items-center">
                <h3 className={`text-base md:text-lg font-normal text-[#2E2B28B3] ${isActive? "text-[#2E2B28]" : "text-[#2E2B28B3]"}`}>
                  {faq.question}
                </h3>
              ...
              {isActive && (
                <p className="mt-4 text-md font-light text-[#2E2B2880]">{faq.answer}</p>
              )}
            </div>
          );
        })}
