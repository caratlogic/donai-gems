...
import RingImage from "../assets/red-ring.jpg";
...
const DianoBanner = () => {
  return (
    <section className="relative w-full max-w-7xl mx-auto py-16 bg-[#FAF8F2] text-[#2E2B28]">
      ...
      <div className="w-full flex flex-col md:flex-row items-center">
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center items-center text-center px-4 md:px-0 min-h-[300px]">
          <div>
            ...
            >
              Step into a world of rare gems and refined craftsmanship. Schedule
              your private session or explore our curated collection.
            </p>
            <button
